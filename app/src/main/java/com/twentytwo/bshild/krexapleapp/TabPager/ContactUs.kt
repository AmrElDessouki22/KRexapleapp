 ...
 * [ContactUs.OnFragmentInteractionListener] interface
...
class ContactUs : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v = inflater.inflate(R.layout.fragment_contact_us, container, false)
        lateinit var webview: WebView
        webview = v.findViewById(R.id.webview)
        var loading = loading(v)
        loading.loading(true)
        webview.loadUrl("https://kr.net.sa/v1/contact-us/")
