 ...
 * [Gallary.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Gallary.newInstance] factory method to
 * create an instance of this fragment.
 */
class Gallary : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v:View =inflater.inflate(R.layout.fragment_gallary, container, false)
        // Inflate the layout for this fragment
        webview = v.findViewById(R.id.webview)
        var loading = loading(v)
        loading.loading(true)
        webview.loadUrl("https://kr.net.sa/v1/gallery/")
