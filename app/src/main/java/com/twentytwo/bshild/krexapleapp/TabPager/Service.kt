 ...
 * [Service.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Service.newInstance] factory method to
...
class Service : Fragment() {
    ...
    override fun onCreateView(
        ...
        webview.loadUrl("https://kr.net.sa/v1/services-2/")
    ...
    companion object {
         ...
         * @return A new instance of fragment Service.
         */
