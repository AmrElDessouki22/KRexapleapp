 ...
 * [Upcomming.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Upcomming.newInstance] factory method to
...
class Upcomming : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v = inflater.inflate(R.layout.fragment_upcomming, container, false)
        lateinit var webview: WebView
        webview = v.findViewById(R.id.webview)
        var loading = loading(v)
        loading.loading(true)
        webview.loadUrl("https://kr.net.sa/v1/upcoming-events/")
    ...
    companion object {
         ...
         * @return A new instance of fragment Upcomming.
         */
